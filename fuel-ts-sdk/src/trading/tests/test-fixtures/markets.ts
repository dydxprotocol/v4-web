...
import type { AssetPrice, Candle, MarketConfig } from '@/trading/src/markets/domain';
 ...
 */
export function createTestAssetPrice(overrides: Partial<AssetPrice> = {}): AssetPrice {
  const base: AssetPrice = {
