...
// camelCase exports for convenience
export const deployerPK = DEPLOYER_PK;
export const user0PK = USER_0_PK;
export const user1PK = USER_1_PK;
export const user2PK = USER_2_PK;
export const liquidatorPK = LIQUIDATOR_PK;
