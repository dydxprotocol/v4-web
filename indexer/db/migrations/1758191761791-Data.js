module.exports = class Data1758191761791 {
    name = 'Data1758191761791'

    async up(db) {
        await db.query(`CREATE TABLE "price" ("id" character varying NOT NULL, "asset_id" text NOT NULL, "timestamp" integer NOT NULL, "price" text NOT NULL, CONSTRAINT "PK_d163e55e8cce6908b2e0f27cea4" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "position" ("id" character varying NOT NULL, "collateral_amout" numeric NOT NULL, "size" numeric NOT NULL, "timestamp" integer NOT NULL, "position_key_id" character varying, CONSTRAINT "PK_b7f483581562b4dc62ae1a5b7e2" PRIMARY KEY ("id"))`)
