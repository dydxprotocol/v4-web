module.exports = class Data1762038504504 {
    name = 'Data1762038504504'

    async up(db) {
        await db.query(`CREATE TABLE "price" ("id" character varying NOT NULL, "asset" text NOT NULL, "timestamp" integer NOT NULL, "price" text NOT NULL, CONSTRAINT "PK_d163e55e8cce6908b2e0f27cea4" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "position" ("id" character varying NOT NULL, "collateral_amout" text NOT NULL, "size" text NOT NULL, "timestamp" integer NOT NULL, "latest" boolean NOT NULL, "change" character varying(9) NOT NULL, "collateral_transferred" text NOT NULL, "position_fee" text NOT NULL, "funding_rate" text NOT NULL, "pnl_delta" text NOT NULL, "realized_funding_rate" text NOT NULL, "realized_pnl" text NOT NULL, "position_key_id" character varying, CONSTRAINT "PK_b7f483581562b4dc62ae1a5b7e2" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_3306a154148b37f510ef9e5daf" ON "position" ("position_key_id") `)
        await db.query(`CREATE TABLE "total_position" ("id" character varying NOT NULL, "index_asset_id" text NOT NULL, "is_long" boolean NOT NULL, "collateral_amout" text NOT NULL, "size" text NOT NULL, "last_timestamp" integer NOT NULL, CONSTRAINT "PK_0235342f5c87dcfa198b732d7a4" PRIMARY KEY ("id"))`)
