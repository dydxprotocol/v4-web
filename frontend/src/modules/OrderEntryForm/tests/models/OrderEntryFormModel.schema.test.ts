...
import { createOrderEntryFormSchema } from '../../src/models/OrderEntryFormModel.schema';
...
describe('orderEntryFormSchema', () => {
  ...
  describe('margin sufficiency validation', () => {
    ...
    // TODO: Schema doesn't validate positionSize = collateralSize × leverage relationship
