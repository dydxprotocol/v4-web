...
import { DecimalCalculator, DecimalValue } from 'fuel-ts-sdk';
...
export const PositionSizeInputs: FC = () => {
  ...
  useEffect(() => {
    ...
    if (focusedField === 'collateralSize') {
      ...
      const nextPositionSize = DecimalCalculator.value(sizeDv)
    ...
    if (focusedField === 'positionSize') {
      ...
      const nextCollateralSize = DecimalCalculator.inNumerator((calc) => calc.value(sizeDv))
