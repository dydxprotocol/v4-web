import { $decimalValue, type DecimalValueInstance } from 'fuel-ts-sdk';
import { propify } from '@/lib/propify';
import * as styles from './PositionField.css';
  ...
  return (
    <div css={styles.positionField}>
      ...
      <span css={getValueStyles()}>
        {symbol}
        {$decimalValue(value).toFloat().toFixed(precision)}
      </span>
    </div>
  );
}
