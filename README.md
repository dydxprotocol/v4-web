...
- `VITE_PRIVY_APP_CLIENT_ID` (optional): App Client ID used for enabling Privy authentication. For deployment of DYDX token holders use `client-WY2jY1XhCXytbdxXXTwDuDToiPtTiyKCMGsX7oj25hUcF`.
