  ...
  const submitButtonReceipt = [
    {
      ...
      value: (
        <Output
          ...
          value={route?.route.usdAmountOut}
        />
      ),
    },
    ...
    },
    {
      ...
      value: (
        <Output
          ...
          value={
            typeof route?.route.estimatedRouteDurationSeconds === 'number'
              ? stringGetter({
                  key: STRING_KEYS.X_MINUTES_LOWERCASED,
                  params: {
                    X:
                      route?.route.estimatedRouteDurationSeconds < 60
                        ? '< 1'
                        : Math.round((route?.route.estimatedRouteDurationSeconds ?? 0) / 60),
                  },
                })
              : undefined
          }
