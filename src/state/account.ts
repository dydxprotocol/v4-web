...
export type AccountState = {
  ...
  chooseWalletDisplay: 'signin' | 'wallets' | 'qr';
};
...
export const accountSlice = createSlice({
  ...
  reducers: {
    ...
    setChooseWalletDisplay: (state, action: PayloadAction<'signin' | 'wallets' | 'qr'>) => ({
      ...state,
