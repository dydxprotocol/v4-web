...
export const UNISWAP_VENUES = [
  ...
  // TODO: followup with skip about making logoUri and optional property
].map((x) => ({ ...x, logoUri: 'fake-logo-uri-this-doesnt-matter' }));

// TODO: unhardcode this. same as above.
export const COSMOS_SWAP_VENUES = [
  {
    name: 'osmosis-poolmanager',
    chainID: 'osmosis-1',
    logoUri: 'fake-logo-uri-this-doesnt-matter',
  },
  {
...
export const getNetworkTypeFromWallet = (connectedWalletInfo?: WalletInfo): NetworkType => {
