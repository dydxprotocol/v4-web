...
const TradeForm = ({
  ...
  const { isViewingUnlaunchedMarket } = useCurrentMarketId(AppRoute.TradeForm);
  ...
  return (
    <div tw="flexColumn items-center gap-2 pb-[12.5rem] pt-[6.5vh]">
      <TradeFormHeaderMobile />
      <div tw="flexColumn w-full items-center gap-0.5">{sizeToggle}</div>
